...
class TestMembership(test_common.TransactionCase):
    ...
    def test_invoiced_membership(self):
        ...
        #   File "/opt/odoo/src/odoo/fields.py", line 835, in __get__
        #     return record._cache[self]
        #   File "/opt/odoo/src/odoo/models.py", line 6132, in __getitem__
        #     return value.get() if isinstance(value, SpecialValue) else value
        #   File "/opt/odoo/src/odoo/fields.py", line 39, in get
        #     raise self.exception
        invoice_ids = self.partner.create_membership_invoice(email=False)
